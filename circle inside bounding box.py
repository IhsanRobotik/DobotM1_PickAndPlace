...
image_path = "20250511_124939.jpg" 

def circle_inside_bounding_box(img):
    # if len(img.shape) == 3:  # If the image has 3 channels (BGR)
...
# sus = circle_inside_bounding_box(frame)
